                ...
                <Container>
                    <Grid container>
                        ...
                        <Grid className="item-container" data-aos="fade-left" item xs={12} md={6}>
                            ...
                            <p className="item-content">Presented a paper titled <b>Motion Microscope to detect Covid-19</b></p>
                        ...
                        <Grid className="item-container" data-aos="fade-right" item xs={12} md={6}>
                            ...
                            <p className="item-content"><b>Certified Grade A in Business English Communication</b></p>
                        ...
                        <Grid className="item-container" data-aos="fade-left" item xs={12} md={6}>
                            <h3 className="item-heading">Toastmasters Evaluation Speech Contest</h3>
                        ...
                        <Grid className="item-container" data-aos="fade-right" item xs={12} md={6}>
                            ...
                            <p className="item-content"><b>from The Hindu Group</b></p>
                            <p className="item-content">Assessment of Listening, Speaking, Reading and Writing skills</p>
