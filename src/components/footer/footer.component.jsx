...
export default function Footer() {
  const url = "akashamba.me";
  return (
    <div id="footer">
      <p>
        <AnchorLink href={footer.home} className="footer-link">
          Home
        </AnchorLink>
        &nbsp; | &nbsp;
        <a href={footer.resume} className="footer-link">
          Resumé
        </a>
        &nbsp; | &nbsp;
        <a href={footer.phone} className="footer-link">
          Phone
        </a>
        &nbsp; | &nbsp;
        <a href={footer.email} className="footer-link">
          E-mail
        </a>
        &nbsp; | &nbsp;
        <a href={footer.feedback} className="footer-link">
          Feedback
        </a>
      </p>
      <br />
      ...
      <p>
        {socials.map((icon) => (
          <a key={icon.name} href={icon.link}>
            <i className={`footer-icon ${icon.name}`}></i>
          </a>
        ))}
      </p>
      <br />
