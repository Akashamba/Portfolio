      ...
      "items": [
        {
          ...
          "subHeading": "Basik Marketing",
          "subSubHeading": "Feb 2022 - Present",
          "description": "Working with the platform development team of The Esports Club - An IP of Basik Marketing Pvt. Ltd. to develop a new platform with the aim of powering Esports experiences in South Asia."
        },
        {
          "mainHeading": "Undergraduate Research Assistant",
          "subHeading": "Solarillion Foundation",
          "subSubHeading": "Jan 2021 - Dec 2021 • 1yr",
          "description": "Developed a Flight Delay Prediction Model. Worked on Citation Intent Classification."
        },
        {
          "mainHeading": "Software Engineer Intern",
          "subHeading": "PALS: An Initiative by Alumni of IITs",
          "subSubHeading": "Jan 2021 - June 2021 • 6 mos",
          "description": "Working with the platform development team of The Esports Club - An IP of Basik Marketing Pvt. Ltd. to develop a new platform with the aim of powering Esports experiences in South Asia"
        },
        {
          "mainHeading": "Software Engineer Intern",
          "subHeading": "Nokia Networks",
          "subSubHeading": "Oct 2020 - Jan 2021 • 4 mos",
          "description": "Developed a web application to help the Nokia Warehouse manage their inventory. The application was built using React and Node.js. The application was used by the warehouse team to manage inventory."
        }
      ],
      "options": {
      ...
      "items": [
        {
          ...
          "description": "Proposed a Single Sign-On Authentication System that uses Government IDs to authenticate users. Patent issued by German Patent and Trademark Office.",
          "link": ["Patent Certificate", "https://drive.google.com/file/d/1TFlC6xAzcwiONRcXzoJSf6gm8ATKjbNh/view?usp=sharing"]
        },
        {
          "mainHeading": "Dynamic Branch Predictor",
          "description": "Leading a team of three, in developing a Dynamic Branch Predictor using Deep Learning. Working under the supervision of Dr. Chakraborty, NTNU, Trondheim, Norway."
        },
        {
          "mainHeading": "Flight Delay Prediction System",
          "description": "A Predictive Machine Learning Engine that can classify delayed flights and predict their delay period.",
          "link": ["Source Code", "https://github.com/Akashamba/Flight-Delay-Prediction"]
        },
        {
          "mainHeading": "Portfolio Webpage",
          "description": "My portfolio website (this website). Built using ReactJS.",
          "link": ["Web App", "https://akashamba.netlify.app/"]
        },
        {
          "mainHeading": "Coronavirus Tracker",
          "description": "A web app that tracks the spread of Covid-19 worldwide and provides useful data visualization. Developed using ReactJS and hosted on Netlify.",
          "link": ["Web App", "https://coronavirus-tracker-live.netlify.app/"]
        },
        {
          "mainHeading": "Dictionary App",
          "description": "A UI-focused web app that provides a dictionary of words and their meaning. Built using the Oxford Dictionary API. Developed using ReactJS and hosted on Netlify.",
          "link": ["Web App", "https://simple-dictionary.netlify.app/"]
        }
      ],
      "options": {
